...
![Valve (Tier 3)](../assets/generated/icon_valve_tier_3.png)

`novadyne:valve_tier_3`

**Upgrade da Lithography.** Tier 3: 78.33% de sucesso e 21.67% de falha na gravação. A valve não é consumida.
...
- Craft de [Valve (Tier 4)](../itens/valve_tier_4.md).
