...
![Valve (Tier 5)](../assets/generated/icon_valve_tier_5.png)

`novadyne:valve_tier_5`

**Upgrade da Lithography.** Tier 5: 86.67% de sucesso e 13.33% de falha na gravação. A valve não é consumida.
...
- Craft de [Valve (Tier 6)](../itens/valve_tier_6.md).
